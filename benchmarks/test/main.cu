...
int main(int argc, char** argv) {
    ...
    try {
        ...
        */
        ...
        range_t<float> h_range((uint64_t)0, (uint64_t)n_elems, (uint64_t)0, (uint64_t)(t_size/page_size), (uint64_t)0, (uint64_t)page_size, &h_pc, settings.cudaDevice);
        ...
        array_t<float> a(n_elems, 0, vr, settings.cudaDevice);
