...
void Settings::parseArguments(int argc, char** argv)
{
    OptionMap parsers = {
        ...
        {'p', OptionPtr(new Range(numPages, 1, (uint64_t)std::numeric_limits<uint64_t>::max, "pages", "number of pages per req", "1"))},
        ...
        {'q', OptionPtr(new Range(queueDepth, 2, 65536, "queue_depth", "queue depth", "16"))},
