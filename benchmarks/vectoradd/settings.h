...
{
    OptionMap parsers = {
        {'a', OptionPtr(new Option<const char*>(input_a, "path", "input", "File path A file is. Provide .bel path."))},
        {'b', OptionPtr(new Option<const char*>(input_b, "path", "input", "File path B file is. Provide .bel path."))},
        ...
        {'s', OptionPtr(new Option<uint64_t>(vsize, "number", "vsize", "specify vector size for both A and B. Default uses 1M elements", "1048576"))},
